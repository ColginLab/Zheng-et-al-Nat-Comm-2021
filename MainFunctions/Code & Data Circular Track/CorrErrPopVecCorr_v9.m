%% Plot Xcorrelation matrix between a pair of trials (Separate reward preexiting and reward emerged cells)
% This version make pairs of trials into variables
function CorrErrPopVecCorr_v9(trackdata,AnalysisFD)
...
outdir = strcat(AnalysisFD,'\CorrErrPopVecCorr_cellType');
if ~isdir(outdir)
    mkdir(outdir)
end
