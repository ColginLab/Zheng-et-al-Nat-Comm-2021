...
function RunConfusionMatrix_AcrossTrials_v3(Parentfd,trackdata,Outdir,cellList,spktime_fd)

outdir = strcat(Outdir,'\ConfusionMatrix_PreRunTunning');
if ~isdir(outdir)
    mkdir(outdir)
end
...
save(strcat(outdir,'\ConfusionMat.mat'),'ConfusionMat')
