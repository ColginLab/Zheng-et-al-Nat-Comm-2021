...
BayesDecodDir = 'E:\ColginLab\MATLAB\Dependencies\BayesianDecodingRipple';
...
RunBayesianDecoder_ripple(pathRats,CSClist_CA1,Outdir,cellList,spktime_fd,trackdata,true,FigDir);
% Relevant figures: BayesianDecoding_ripple\R2distCorrectVSIncorrect, 
%                   BayesianDecoding_ripple\BayesianDecodingExamples
end