...
% this version align error trials to stop location
function CorrErrPopVecCorr_v11(trackdata,AnalysisFD)
...
outdir = strcat(AnalysisFD,'\CorrErrPopVecCorr_allcells_alignedToStopLoc');
if ~isdir(outdir)
    mkdir(outdir)
end
